...
public class DifferenceMatcherTest {
    ...
    public void testSimple() {
        ...
        List<Difference> diffList = Lists.newArrayList(
                new Difference(DifferenceEvent.inserted, "argus", "Argus Panoptes is the name of the 100 eyed giant in No"),
                new Difference(DifferenceEvent.inserted, "panopt", "Argus Panoptes is the name of the 100 eyed giant in Norse mytho"),
                new Difference(DifferenceEvent.inserted, "name", "Argus Panoptes is the name of the 100 eyed giant in Norse mythology"),
                new Difference(DifferenceEvent.deleted, "greek", "is the of the 100 eyed giant in Greek mythology"),
                new Difference(DifferenceEvent.inserted, "nors", "gus Panoptes is the name of the 100 eyed giant in Norse mythology")
        );
