...
public class EMEAPlainEvaluation {
    ...
    public void test() {
        ...
        File indexFolder = new File(Util.INSTALL_DIR, "index");
        indexFolder.mkdirs();
        File documentsFolder = new File(Util.INSTALL_DIR, "documents");
        documentsFolder.mkdirs();

        // index EMEA plain text corpus
        Collection collection = cb.buildInFolders(indexFolder, documentsFolder);
