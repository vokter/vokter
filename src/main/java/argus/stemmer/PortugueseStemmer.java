...
import argus.stemmer.snowball.SnowballStemmer;
 ...
 * <p/>
 * This class was, however, modified to handle MutableStrings instead of
 * StringBuffers, since mutable strings perform byte allocation instead of
 * instantiating new immutable string each time a modification is performed (as the
 * Java String does).
 */
public class PortugueseStemmer extends SnowballStemmer implements Stemmer {
...
//                    if (input.length() > 0) {
//                        setCurrent(input.toString());
//                        for (int i = repeat; i != 0; i--) {
//                            stem();
//                        }
//                        output.append(getCurrent());
//                        output.append(' ');
...
//            throw new RuntimeException("There was a problem stemming the " +
//                    "specified document content!");
//        }
