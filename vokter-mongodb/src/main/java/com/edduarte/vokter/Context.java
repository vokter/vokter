...
public class Context implements LifeCycle.Listener, JobManagerHandler {
    ...
    public boolean sendNotificationToClient(String documentUrl, String documentContentType,
                                            ...
                                            Set<Match> diffs) {
        Session session = createOrGetSession(clientUrl, clientContentType);
    ...
    private Session createOrGetSession(String clientUrl, String clientContentType) {
        ...
        if (obj == null) {
            ...
            MongoSession s = new MongoSession(clientUrl, clientContentType, token);
            collection.insert(s);
            return s;
        } else {
    ...
    public DetectResult detectDifferences(String url, String contentType) {
        ...
        DocumentCollection.Pair pair = documentCollection.get(url, contentType);
        ...
        if (pair != null) {
            ...
            DiffDetector detector = new DiffDetector(oldDocument, newDocument, MongoDiff.class);
            ...
            documentCollection.add(newDocument);
