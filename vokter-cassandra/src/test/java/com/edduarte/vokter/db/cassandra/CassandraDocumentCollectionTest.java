...
package com.edduarte.vokter.db.cassandra;

import com.edduarte.vokter.persistence.DocumentCollection;
import com.edduarte.vokter.persistence.cassandra.CassandraDocumentCollection;
 ...
 * @since 1.0.0
 */
public class CassandraDocumentCollectionTest {

    private static final Logger logger = LoggerFactory.getLogger(CassandraDocumentCollectionTest.class);
    ...
    public static void setUp() throws IOException, InterruptedException {
        ...
        collection = new CassandraDocumentCollection(db);
