 ...
 * @since 1.0.0
 */
public class CassandraSession extends BasicDBObject
    ...
    public CassandraSession(String clientUrl, String clientContentType, String token) {
        super();
    ...
    public CassandraSession(BasicDBObject dbObject) {
        super(dbObject);
    }
    ...
    public boolean equals(Object o) {
        ...
        CassandraSession that = (CassandraSession) o;
