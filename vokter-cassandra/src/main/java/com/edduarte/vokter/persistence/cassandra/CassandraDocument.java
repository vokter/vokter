 ...
 * @since 1.0.0
 */
public final class CassandraDocument extends BasicDBObject
    ...
    public CassandraDocument(String url, Date date, String contentType, String text,
    ...
    public CassandraDocument(BasicDBObject dbObject) {
        super(dbObject);
    }
    ...
    public boolean equals(Object o) {
        ...
        CassandraDocument that = (CassandraDocument) o;
