...
<head>
    ...
    <link href='${swaggerAssetsPath}/css/index.css' rel="stylesheet"/>
    <link href='${swaggerAssetsPath}/css/standalone.css' rel='stylesheet'/>
    <link href='${swaggerAssetsPath}/css/api-explorer.css' rel='stylesheet' type='text/css'/>
    ...
    <script src='${swaggerAssetsPath}/lib/bootstrap.min.js' type='text/javascript'></script>
...
//                    }
                ...
                operationsSorter: function (a, b) {
                    var order = { 'get': '4', 'post': '1', 'put': '2', 'delete': '3' };
